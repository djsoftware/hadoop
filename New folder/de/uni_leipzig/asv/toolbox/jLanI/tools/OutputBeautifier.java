...
public class OutputBeautifier
{
    public static String beautify(Response response)
    {
        ...
        //calc percentages
        double top1_perc = (top1_count.doubleValue() / count) * 100;
        double top2_perc = (top2_count.doubleValue() / count) * 100;
        //format the doubles on 2 numbers behind the comma
        DecimalFormat df = new DecimalFormat("##0.00");
        return top1 + " " + df.format(top1_perc) + "\t" + top2 + " " + df.format(top2_perc);
