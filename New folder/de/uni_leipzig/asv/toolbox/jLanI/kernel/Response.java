/*
 * $Header: /usr/cvs/jlani2/src/de/uni_leipzig/asv/toolbox/jLanI/kernel/Response.java,v 1.1 2006-11-07 13:27:33 ksveds Exp $
 * 
...
public class Response implements Serializable {
   ...
   private HashMap<String,Double> result;
	...
	public LangResult getLangResult(double mincov, int mincount)
	{
		...
		return new LangResult(langAr[0], (int)(valueAr[0].doubleValue()/sum*100),
				      langAr[1], (int)(valueAr[1].doubleValue()/sum*100),
                        this.getLanguageCoverage(langAr[0]), this.getLanguageWordCount(langAr[0]), mincov, mincount);
	}

    @Override
	public String toString() {
        StringBuffer ret = new StringBuffer();
        ret.append("["+this.id+"] Response-Object with values: " + this.result);
    ...
    /**
     * 
     * @param coverage to set ( Map::language->double)
     */
    public void setCoverage(HashMap coverage){
     ...
     /**
     * 
     * @param wordCount to set ( Map::language->int)
     */
    ...
    public double getLanguageCoverage(String lang){
       if (this.coverage==null){
          System.err.println("Response-Object #"+this.id+": Attention! this is an reduced dataset! There are no coverage informations available!");
          return -1.0;
       }
       if(this.coverage.containsKey(lang)) {
		return ((Double)this.coverage.get(lang)).doubleValue();
	} else {
          System.err.println("Response-Object #"+this.id+": Attention! language "+lang+" not found!");
          return -1.0;
       }
    }
