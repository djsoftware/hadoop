/*
 * $Header: /usr/cvs/jlani2/src/de/uni_leipzig/asv/toolbox/jLanI/kernel/Request.java,v 1.1 2006-11-07 13:27:33 ksveds Exp $
 * 
    ...
    public Request( String sentence, Set languages, int modus, boolean reduce )
        ...
        if ( languages == null ) {
			throw new RequestException(
			        "the set of languages cannot be null!" );
		}
