...
public class LangResult 
{
	...
	public LangResult(String l1, int p1, String l2, int p2, double c, int wc, double mcv, int mco)
	{
		...
		prob2 = p2;
                ...
                MINWORDCOUNT=mco;
                MINCOVERAGE=mcv;
                //System.out.println(l1+" "+l2+" "+p1+" "+p2+" "+coverage1+" "+wordcount1);
	}

	@Override
	public String toString()
	{
		return (isKnown()) ? lang1+"\t"+prob1+"\t"+lang2+"\t"+prob2 : "unknown";
	}
	...
	public boolean isKnown()
	{
        ...
        // is at least twice as the value of the second language, exceeds minwordcount, exceeds mincov
           if (prob1 < 2*prob2) {retval=false;}
           if (wordcount1< MINWORDCOUNT) {retval=false; }
           if (coverage1 < MINCOVERAGE) {retval=false;}
